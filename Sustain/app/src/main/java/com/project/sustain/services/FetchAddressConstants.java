...
public class FetchAddressConstants {
    ...
    public static final String LOCATION_RESULT_ADDRESS = PACKAGE_NAME + ".LOCATION_RESULT_ADDRESS";
    public static final String LOCATION_RESULT_ADDRESS_AS_LIST = PACKAGE_NAME + ".LOCATION_RESULT_ADDRESS_AS_LIST";
    public static final String LOCATION_RESULT_LATITUDE = PACKAGE_NAME + ".LOCATION_RESULT_LATITUDE";
    public static final String LOCATION_RESULT_LONGITUDE = PACKAGE_NAME + ".LOCATION_RESULT_LONGITUDE";
